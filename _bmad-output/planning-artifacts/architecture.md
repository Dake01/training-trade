...
Epic 2 is a single accounting pipeline. The same ordered decision timeline and the same portfolio snapshots must feed the current portfolio view, the equity curve, and the session stats.
